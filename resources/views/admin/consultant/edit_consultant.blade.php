...
@section('content')
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        ...
                                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Experiences</a>
                                        </li>
                                    </ul>
                                                ...
                                                <table class="data table table-striped no-margin">
                                                    ...
                                                    @foreach($user->experiences as $experience)
                                                        <tr>
                                                            ...
                                                            <td>{{$experience->sub_category->name}}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="" onclick="deleteExperienceModal({{$experience->id}})" style="color: red;" data-toggle="modal" data-target="#deleteExperienceModal">
                        ...
                        <div id="user-profile-edit-section" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <br/>
                                    <form id="demo-form3" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="/admin/consultant/experience/edit" enctype="multipart/form-data">
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <div id="service-container">
                                                <div id="initial-div">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="form-control" name="experience_cat_id[]">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <select class="form-control" name="experience_sub_cat_id[]">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Years</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="modal fade" id="deleteExperienceModal" tabindex="-1" role="dialog" aria-labelledby="deleteExperienceModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                ...
                <div class="modal-body">
                    ...
                    <form id="delete-experience-form" method="POST" action="/admin/consultant/experience/delete">
                        <input type="hidden" name="id" id="experience-id">
                        @csrf
                    </form>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" onclick="deleteExperienceForm()" class="btn btn-danger" id="submitButton">Delete Experience</button>
                    </div>
                </div>
            </div>
        </div>
