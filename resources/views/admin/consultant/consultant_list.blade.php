                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="/admin/consultant/edit/{{$user->id}}"><i data-toggle="tooltip" title="Edit" class="fa fa-edit"></i></a>
                                        @if($userType == 'Disabled Consultant')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if($userType == 'Disabled Consultant')
                        <h4>Are you sure you want to activate this consultant?</h4>
                    @else
                        <h4>Are you sure you want to disable this consultant?</h4>
                    @endif
                    ...
                    <div class="modal-footer">
                        ...
                        @if($userType == 'Disabled Consultant')
                            <button type="button" onclick="disableForm()" class="btn btn-success" id="submitButton">Activate Consultant</button>
                        @else
                            <button type="button" onclick="disableForm()" class="btn btn-danger" id="submitButton">Disable Consultant</button>
                        @endif
                    </div>
                </div>
            </div>
