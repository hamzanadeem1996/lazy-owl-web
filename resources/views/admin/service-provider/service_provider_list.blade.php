                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="/admin/service-provider/edit/{{$user->id}}"><i data-toggle="tooltip" title="Edit" class="fa fa-edit"></i></a>
                                        @if($userType == 'Disabled Service Provider')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if($userType == 'Disabled Service Provider')
                        <h4>Are you sure you want to activate this Service Provider?</h4>
                    @else
                        <h4>Are you sure you want to disable this Service Provider?</h4>
                    @endif
                    ...
                    <div class="modal-footer">
                        ...
                        @if($userType == 'Disabled Service Provider')
                            <button type="button" onclick="disableForm()" class="btn btn-success" id="submitButton">Activate Service Provider</button>
                        @else
                            <button type="button" onclick="disableForm()" class="btn btn-danger" id="submitButton">Disable Service Provider</button>
                        @endif
                    </div>
                </div>
            </div>
