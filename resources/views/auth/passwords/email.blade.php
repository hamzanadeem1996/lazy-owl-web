                    ...
                    <div class="row home-row mb-0">
                        <div class="col-12 col-lg-6 col-xl-4 col-md-12">
                            <div class="home-text">
                                ...
                                <p class="white mb-5">
                                    Please use your email to reset password.<br>
                                    If you are not a member, please <a href="/register" class="white-underline-link">register</a>.
                                </p>
                                <form class="dark-background" method="POST" action="{{ route('password.email') }}">
                                    @csrf
                                    ...
                                    <button class="btn btn-outline-semi-light btn-xl mt-4" type="submit">SEND PASSWORD RESET LINK</button>
                                </form>
                            </div>
                        </div>
                    </div>
